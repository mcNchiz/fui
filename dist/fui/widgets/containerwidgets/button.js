...
class Button extends containerwidget_1.ContainerWidget {
    constructor({ child = null, centeredItems = false, type, onClick = () => { console.log("onClick not defined"); }, color, weight, size, decoration = new design_1.BoxDecoration({ width: "auto", border: 0, padding: design_1.EdgeInsets.zero }) }) {
        super({ child });
